...
const BLOG = {
  ...
  NOTION_PAGE_ID: '158a4d463c768046be51d19153c5782d',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'jinzhepro', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '路漫漫其修远兮，吾将上下而求索。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jinzhepro.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客,前端,js,html,css', // 网站关键词 英文逗号隔开
